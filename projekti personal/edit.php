  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="race_name" name="race_name" value="<?php echo  $user_data['race_name'] ?>">
          <label for="floatingInput">Race Name</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="race_rating" name="race_time" value="<?php echo  $user_data['race_time'] ?>">
