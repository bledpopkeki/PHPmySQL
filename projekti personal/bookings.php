<?php 
   ...
   $user_id = $_SESSION['id'];
     ...
     $sql = "SELECT races.race_name, users.email,bookings.id, bookings.nr_tickets, bookings.date, bookings.is_approved, bookings.time FROM races
     INNER JOIN bookings ON races.id = bookings.race_id
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <?php foreach ($bookings_data as $booking_data) { ?>
               ...
               <tr>
                <td><?php echo $booking_data['race_name']; ?></td>
