          ...
          <tbody>
            <?php foreach ($users_data as $user_data) { ?>
               ...
               <tr>
                ...
                <td><?php echo $user_data['race_name']; ?></td>
                <td><?php echo $user_data['race_time']; ?></td>
                <td><?php echo $user_data['race_date']; ?></td>
                <td><?php echo $user_data['race_price']; ?></td>
                <td><?php echo $user_data['race_image']; ?></td>
